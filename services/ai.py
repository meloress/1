...
_NEARBY_TOOL = {
    ...
    "description": (
        ...
        "Natijada har bir joyning nomi, MASOFASI, koordinatasi va tayyor "
        "yo'nalish havolasi keladi. Javobda eng yaqin 3-5 tasini masofasi "
        "bilan sanang, eng mosining koordinatasini [xarita:lat,lon,16] "
        "belgisi bilan ko'rsating va uning yo'nalish havolasini "
        "[tugma: Yo'nalish | HAVOLA] qilib qo'ying — foydalanuvchi bosib "
        "navigatsiyani ochadi.\n"
        "⚠️ Havolani AYNAN ko'chiring, o'zgartirmang va o'zingiz "
        "yozmang — qayta yozilgan havola ochilmaydi.\n\n"
